...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var filteredArray = sampleArray.filter(sampleObject => sampleObject.id == sample);
    var filteredMetadata = metadataArray.filter(sampleObject => sampleObject.id == sample);
